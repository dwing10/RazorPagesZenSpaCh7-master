    ...
    public partial class ClientAndAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2020, 10, 17, 22, 12, 29, 51, DateTimeKind.Local).AddTicks(3198), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2020, 10, 17, 22, 12, 29, 53, DateTimeKind.Local).AddTicks(110), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2020, 10, 17, 22, 12, 29, 53, DateTimeKind.Local).AddTicks(68), 7 });
