...
namespace RazorPages.Migrations
{
    ...
    [Migration("20201018021229_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 17, 22, 12, 29, 51, DateTimeKind.Local).AddTicks(3198),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2020, 10, 17, 22, 12, 29, 53, DateTimeKind.Local).AddTicks(68),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 17, 22, 12, 29, 53, DateTimeKind.Local).AddTicks(110),
                            ServicesID = 5
                        });
                });
